...
const loginUser = async (username: string, password: string) => {
    return apiOauth.post('/users/login', new URLSearchParams({username, password}), {
    ...
    return (
        <div className="fixed z-50 inset-0 flex items-center justify-center h-screen bg-white">
            <div className="p-6 w-full max-w-sm">
                <h2 className="text-2xl font-bold text-center mb-6">{t('authorization')}</h2>
                <form onSubmit={handleSubmit} className="space-y-2">
                    <div>
                        <input
                            ...
                            placeholder={t("authorization_input_placeholder_username")}
                            required
                        />
                    </div>
                    <div>
                        <input
                            ...
                            placeholder={t("authorization_input_placeholder_password")}
                            required
                        />
                    </div>
                    <button
                    ...
                    >
                        {t("authorization_button_sign_in")}
                    </button>
                </form>
            </div>
        </div>
